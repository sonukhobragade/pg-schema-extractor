# AGENTS.md — pg-schema-extractor

> Extract and fingerprint PostgreSQL schema objects for change detection
...
- **Stack**: Python, psycopg2, PostgreSQL
- **Interface registry**: none (database only)
